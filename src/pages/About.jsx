        ...
        <div className="container">
          ...
          <div className="values-grid">
            ...
            <div className="value-card">
              ...
              <p className="value-text">
                Taking full responsibility of our actions and the outcomes of our strategic initiatives and programs.
              </p>
            </div>
            <div className="value-card">
      ...
      <section className="goals-section" id="strategic-goals">
        <div className="container">
          <div className="goals-header">
            ...
            <p className="section-subtitle">
              Our roadmap for transforming the Northern Cape into a leading economic and tourism hub
            </p>
          </div>
          ...
          <div className="management-grid">
            <div className="management-card">
              ...
              <div className="management-info">
                ...
                <p className="management-role">Member of the Executive Council</p>
      ...
      <section className="org-section" id="org-structure">
        <div className="container">
          <div className="org-header">
            ...
            <p className="org-subtitle">Hierarchical overview of departmental programmes and reporting lines</p>
          </div>
        ...
        <div className="container">
          <div className="reports-header">
            ...
            <a className="reports-archive" href="#">
              View Archive <svg className="icon-sm" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" /></svg>
            </a>
          </div>
          <div className="reports-grid">
            <div className="report-card">
              ...
              <div>
                ...
                <p className="report-desc">Financial audited statements and performance metrics for the last fiscal year.</p>
              </div>
            ...
            <div className="report-card">
              ...
              <div>
                ...
                <p className="report-desc">Annual Performance Plan detailing departmental targets and service delivery goals.</p>
              </div>
              <button className="report-download">Download PDF</button>
            </div>
            <div className="report-card">
              ...
              <div>
                ...
                <p className="report-desc">Long-term vision and framework for socio-economic transformation in the province.</p>
              </div>
              <button className="report-download">Download PDF</button>
            </div>
          </div>
